...
// this code can be placed directly in pallazza.html
vis.binds.pallazza = {
    version: "0.5.0",
    showVersion: function () {
        if (vis.binds.pallazza.version) {
            console.log('Version pallazza: ' + vis.binds.pallazza.version);
            vis.binds.pallazza.version = null;
        }
    },
	createWidget: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds.pallazza.createWidget(widgetID, view, data, style);
            }, 100);
        }
        ...
        if (data.oid) {
            vis.states.bind(data.oid + '.val', function (e, newVal, oldVal) {
                $div.find('.pallazza-value').html(newVal);
            });
        }
    }
};
	
vis.binds.pallazza.showVersion();
